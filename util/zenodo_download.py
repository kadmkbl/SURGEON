"""
Ref: https://raw.githubusercontent.com/RobustBench/robustbench/53bbb1c722f92ae4d733f4a6d730fcc97f6f51e8/robustbench/zenodo_download.py
LICNES: MIT licens. Refer to https://github.com/RobustBench/robustbench/blob/ecc9f33dc5ce8f4febc24c844d959319885d4198/LICENSE
"""
import hashlib
import shutil
...
def zenodo_download(record_id: str, filenames_to_download: Set[str],
    ...
    for file in files_to_download:
        if (save_dir / file["key"]).exists():
            # shutil.unpack_archive("/data/user21100736/Works/Reference/MECTA-main/data/cifar100/CIFAR-100-C.tar",
