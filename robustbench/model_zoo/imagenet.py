...
from robustbench.model_zoo.architectures.resnet import ResNet, Bottleneck
...
common_corruptions = OrderedDict(
    [
        ...
        ('Hendrycks2020Many', {
            'model': lambda: normalize_model(ResNet(Bottleneck, [3, 4, 6, 3], num_classes=1000), mu, sigma),
